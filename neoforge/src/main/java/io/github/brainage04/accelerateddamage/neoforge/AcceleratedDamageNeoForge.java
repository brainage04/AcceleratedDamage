...
public final class AcceleratedDamageNeoForge implements AcceleratedDamagePlatform {
    ...
    private static final DeferredHolder<GameRule<?>, GameRule<Boolean>> FASTER_EFFECT_TICKING = registerBoolean("faster_effect_ticking");
    ...
    public GameRule<Boolean> registerBooleanGameRule(String path) {
        return switch (path) {
            ...
            case "faster_effect_ticking" -> FASTER_EFFECT_TICKING.get();
